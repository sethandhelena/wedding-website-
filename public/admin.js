...
const PAGE_SCHEMAS={
  home:{label:'Home',file:'index.html',sections:[
    ...
    ['Our Story',[['story_image_url','Our Story image','image'],['story_eyebrow','Eyebrow'],['story_title','Heading'],['story_text','Text','textarea'],['story_button','Read Our Story button'],['story_link','Button link']]],
  ...
  story:{label:'Our Story',file:'story.html',sections:[
    ...
    ['Favorite Moments',[
      ...
      ['moment_1_title','Moment 1 title'],
      ['moment_1_text','Moment 1 text','textarea'],
      ['moment_2_title','Moment 2 title'],
      ['moment_2_text','Moment 2 text','textarea'],
      ['moment_3_title','Moment 3 title'],
      ['moment_3_text','Moment 3 text','textarea']
    ]],
  ...
  rsvp:{label:'RSVP',file:'rsvp.html',sections:[
    ...
    ['RSVP Form',[
      ...
      ['form_children_label','Children label'],
      ['form_meal_label','Meal label'],
      ['form_dietary_label','Dietary restrictions label'],
...
function renderPageEditor(slug){
  ...
  if(slug==='rsvp'){
    const rsvpDefaults={
      ...
      form_dietary_label:'Dietary Restrictions',
  ...
  if(slug==='story'){
    const momentDefaults={
      moment_1_title:'Weekend Getaways',
      moment_1_text:'Road trips, small towns, lake weekends, and finding our favorite places together.',
      moment_2_title:'Sunday Mornings',
      moment_2_text:'Coffee, slow breakfasts, music in the kitchen, and nowhere else we need to be.',
      moment_3_title:'Family Traditions',
      moment_3_text:'Holidays, birthdays, long dinners, and making room for new traditions of our own.'
    };
