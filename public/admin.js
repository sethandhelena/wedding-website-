...
const PAGE_SCHEMAS={
  ...
  wedding:{label:'Wedding',file:'wedding.html',sections:[
    ...
    ['Travel & Stay',[
      ...
      ['hotel_title','Places to stay title'],
      ['hotel_text','Places to stay text','textarea'],
      ['hotel_button','Places to stay button'],
      ['stay_page_link','Places to stay link'],
...
function renderPageEditor(slug){
  ...
  if(slug==='wedding' && !('stay_page_link' in values)){
    values.stay_page_link='stays.html';
  }
