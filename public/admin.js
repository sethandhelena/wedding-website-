...
const PAGE_SCHEMAS={
  ...
  wedding:{label:'Wedding',file:'wedding.html',sections:[
    ...
    ['Travel & Stay',[
      ...
      ['stay_card_link','Places to stay link'],
  ...
  stays:{label:'Places to Stay',file:'stays.html',sections:[
    ['Hero',[
      ['hero_eyebrow','Eyebrow'],
      ['hero_title','Page title'],
      ['hero_intro','Intro'],
      ['hero_image_url','Hero image URL','image']
    ]],
    ['Introduction',[
      ['intro_eyebrow','Eyebrow'],
      ['intro_title','Heading'],
      ['intro_text','Text','textarea']
    ]],
    ['Best Western Plus Willmar',[
      ['stay1_title','Hotel name'],
      ['stay1_address','Address'],
      ['stay1_text','Description','textarea'],
      ['stay1_button','Button label'],
      ['stay1_link','Hotel link']
    ]],
    ['Holiday Inn Express & Suites Willmar',[
      ['stay2_title','Hotel name'],
      ['stay2_address','Address'],
      ['stay2_text','Description','textarea'],
      ['stay2_button','Button label'],
      ['stay2_link','Hotel link']
    ]],
    ['Airbnb & Vacation Rentals',[
      ['stay3_title','Heading'],
      ['stay3_text','Description','textarea'],
      ['stay3_button','Button label'],
      ['stay3_link','Rental link'],
      ['stay_note','Booking note','textarea']
    ]],
    ['Call to Action',[
      ['cta_eyebrow','Eyebrow'],
      ['cta_title','Heading'],
