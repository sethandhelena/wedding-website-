...
const PAGE_SCHEMAS={
  ...
  wedding:{label:'Wedding',file:'wedding.html',sections:[
    ...
    ['Travel & Stay',[
      ...
      ['travel_intro','Intro text','textarea'],
      ['stay1_title','Hotel 1 name'],
      ['stay1_text','Hotel 1 description','textarea'],
      ['stay1_button','Hotel 1 button'],
      ['stay1_link','Hotel 1 link'],
      ['stay2_title','Hotel 2 name'],
      ['stay2_text','Hotel 2 description','textarea'],
      ['stay2_button','Hotel 2 button'],
      ['stay2_link','Hotel 2 link'],
      ['stay3_title','Vacation rental heading'],
      ['stay3_text','Vacation rental description','textarea'],
      ['stay3_button','Vacation rental button'],
      ['stay3_link','Vacation rental link'],
