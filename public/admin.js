...
const PAGE_SCHEMAS={
  home:{label:'Home',file:'index.html',sections:[
    ['Hero',[['hero_eyebrow','Eyebrow'],['hero_title','Main heading'],['hero_intro','Date / location line'],['hero_button','Button label'],['hero_link','Button link'],['hero_image_url','Hero image URL','image']]],
    ['Countdown',[['countdown_eyebrow','Eyebrow'],['countdown_title','Heading']]],
    ['Our Story',[['story_eyebrow','Eyebrow'],['story_title','Heading'],['story_text','Text','textarea'],['story_button','Button label'],['story_link','Button link']]],
    ['Wedding',[['wedding_eyebrow','Eyebrow'],['wedding_title','Heading'],['wedding_text','Text','textarea'],['wedding_button','Button label'],['wedding_link','Button link']]],
    ['RSVP',[['rsvp_eyebrow','Eyebrow'],['rsvp_title','Heading'],['rsvp_text','Text','textarea'],['rsvp_button','Button label'],['rsvp_link','Button link']]],
    ['Registry',[['registry_eyebrow','Eyebrow'],['registry_title','Heading'],['registry_text','Text','textarea'],['registry_button','Button label'],['registry_link','Button link']]],
    ['Journal',[['journal_eyebrow','Eyebrow'],['journal_title','Heading'],['journal_button','View more button'],['journal_link','Button link']]],
    ['Invitation Help',[['help_eyebrow','Eyebrow'],['help_title','Heading'],['help_text','Text','textarea'],['help_button','Button label'],['help_link','Button link']]]
  ]},
